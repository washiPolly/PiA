...
const inventoryItemsSeed = [
  ...
  {
    "invCategory": "Collectibles",
    "invItemName": "The Grinch",
    "invItemDescription": "great for christmas gift too",
    "invItemImgUrl": "https://i.pinimg.com/474x/95/f0/77/95f077482b72ebbe6542f7374f0a9870.jpg",
    "important": "",
    "date": new Date(Date.now())
  },
  {
    "invCategory": "Collectibles",
    "invItemName": "Brick Headz - Mandalorian and The Child",
    "invItemDescription": "just released Star Wars Brick Headz",
    "invItemImgUrl": "https://www.lego.com/cdn/cs/set/assets/bltf26654748edaee26/75317.png?fit=bounds&format=jpg&quality=80&auto=webp&width=528&height=528&dpr=1",
    "important": "Yes",
    "date": new Date(Date.now())
  }
]
...
db.deleteMany({})
  .then(() => db.insertMany(inventoryItemsSeed))
  .then(data => {
